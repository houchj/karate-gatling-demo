...
class CatsKarateSimulation extends Simulation {
  ...
  val query001 = scenario("query001").exec(karateFeature("classpath:mock/query.feature"))
  val query002 = scenario("query002").exec(karateFeature("classpath:mock/query2.feature"))
